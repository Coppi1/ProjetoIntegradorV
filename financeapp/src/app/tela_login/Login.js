...
function Login() {
  ...
  const handleForgotPassword = () => {
    ...
    alert(
      `Um email foi enviado para ${email} com as instruções para redefinição da senha.`
    );
  };
      ...
      <Card className="card">
        <div className="buttoncontainer">
          <Button className="logobutton" onClick={handleCadastroClick}>
            <img
              className="logo"
              src="https://cdn.pixabay.com/photo/2016/12/14/10/39/button-1905961_1280.png"
              alt=""
            ></img>
          </Button>
        </div>
        ...
        <div className="logocontainer">
          <button
            ...
            onClick={() => handleButtonClick("com Facebook")}
          >
            <img
              className="logo"
          ...
          <button
            className="logobutton"
            onClick={() => handleButtonClick("com conta Google")}
          >
            <img
              className="logo"
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Google_Plus_logo_%282015-2019%29.svg/1200px-Google_Plus_logo_%282015-2019%29.svg.png"
              alt=""
            ></img>
          </button>
        </div>
        ...
        <div className="buttoncontainer">
          <Button className="button2" onClick={handleForgotPassword}>
            Esqueceu a senha?
          </Button>
        </div>
        <br></br>
